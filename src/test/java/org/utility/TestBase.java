...
public class TestBase {
	...
	public static void dragAndDropCall(WebElement e, WebElement f) {
		act = new Actions(driver);
	...
	public static void takeScreenshotFullCall(String fileName) throws IOException {
		...
		File dest = new File("C:\\Users\\yuva\\eclipse-workspace\\Cucumberpro\\target\\screenshot\\" + fileName + ".jpg");
